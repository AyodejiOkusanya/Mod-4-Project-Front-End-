...
class App extends React.Component {
  ...
  getVideos = (searchTerm) => {
    ...
    return fetch(TMDB)
      .then(resp => resp.json())
      .then(obj => this.setState({videos: obj.results, hasMore: obj.page <= obj.total_pages}))
  ...
  getVideosFromScroll = (pageNumber) => {
    ...
    return fetch(TMDB)
      .then(resp => resp.json())
      .then(obj => {
        this.setState({videos: [...this.state.videos, ...obj.results], hasMore: obj.page <= obj.total_pages})
